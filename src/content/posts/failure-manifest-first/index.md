...
In our systems, the first place [where a problem will manifest itself]({{< ref "/posts/oodles-disk-space-just-right-place.md" >}}) is in a log of some kind. Be that a text based log or something like Windows event log.
