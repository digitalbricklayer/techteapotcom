...
What these tools are not are drop in replacements for a sysadmin. Neither of the playbooks worked. So, if you are expecting a tool that just works first time with no tweaking, you are going to be disappointed. You still need to know what you are doing. The tools will save you some time or they'll help you learn faster. That's about as good as this generation of tools is going to be.

If I had to choose between the two now, I'd go with Copilot. I think the script is superior as well as the instructions being much clearer.