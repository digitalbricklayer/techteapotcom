...
nt-guide - The Windows NT Guide to MRTG 2.9.22
...
mrtg-2.9.22.zip or better. The archive does also contain a precompiled copy
...
Unzip MRTG to C:\mrtg-2.9.22 on the WindowsNT machine of your choice.
...
and go into F<c:\mrtg-2.9.22\bin>. Type:
...
Get to a cmd prompt and change to the F<c:\mrtg-2.9.22\bin> directory. Type the
following command:
...
results by going into the F<c:\mrtg-2.9.22\bin> directory and typing:
...
C<"c:\mrtg-2.9.22\bin"> after creating the task.  Select the user account
