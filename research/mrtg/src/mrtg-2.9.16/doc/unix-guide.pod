...
unix-guide - Instructions for running MRTG 2.9.16 on a Unix Box
...
Ok now everything is ready for the mrtg compilation.
 ...
 cd /usr/local/src
 gunzip -c mrtg-2.9.16.tar.gz | tar xvf -
 cd mrtg-2.9.16
...
A B<minimal> script to put into F<init.d> might look like this:
 ...
 #! /bin/sh
 cd /usr/local/mrtg-2.9.16/bin && ./mrtg --user=mrtg-user \
