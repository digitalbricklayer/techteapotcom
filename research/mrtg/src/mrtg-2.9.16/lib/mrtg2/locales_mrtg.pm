...
# Simplified Chinese/¼òÌåÖĞÎÄ
   ...
   "  <HR NOSHADE>
    ¼òÌåÖĞÎÄºº»¯
    <NOBR><A HREF=\"http://gamago.heha.com\">Ù¤Âê¹û</A>
...
# Russian/òÕÓÓËÉÊ
   ...
   "  <HR NOSHADE>
    ...
    <NOBR><A HREF=\"http://www.chg.ru/~dima/\">äÍÉÔÒÉÊ óÉ×ÁŞÅÎËÏ</A>
...
$credits::LOCALE{'¼òÌåÖĞÎÄ'}=$credits::LOCALE{'SimChinese'};
...
sub chinese
{
  ...
  (  
     ...
     'Maximal 5 Minute Incoming Traffic'      => '5·ÖÖÓ×î´óÁ÷³öÁ¿',
     'Maximal 5 Minute Outgoing Traffic'      => '5·ÖÖÓ×î´óÁ÷ÈëÁ¿',
     'the device'                             => 'Éè±¸',
     'The statistics were last updated(.*)'   => 'ÉÏ´ÎÍ³¼Æ¸üĞÂÊ±¼ä£º$1',
     ' Average\)</B><BR>'                     => ' Æ½¾ù)</B><BR>',
     '<TD ALIGN=right><SMALL>Average(.*)'     => '<TD ALIGN=right><SMALL>Æ½¾ùÖµ$1',
     '<TD ALIGN=right><SMALL>Max(.*)'         => '<TD ALIGN=right><SMALL>×î´óÖµ$1',
     '<TD ALIGN=right><SMALL>Current(.*)'     => '<TD ALIGN=right><SMALL>µ±Ç°Öµ$1',
     'version'                                => '°æ±¾',
     '<B>`Daily\' Graph \((.*) Minute'        => '<B>Ã¿ÈÕÍ¼±í ($1 ·ÖÖÓ',
     '<B>`Weekly\' Graph \(30 Minute'         => '<B>Ã¿ÖÜÍ¼±í (30 ·ÖÖÓ' ,
     '<B>`Monthly\' Graph \(2 Hour'           => '<B>Ã¿ÔÂÍ¼±í (2 Ğ¡Ê±',
     '<B>`Yearly\' Graph \(1 Day'             => '<B>Ã¿ÄêÍ¼±í (1 Ìì', 
     'Incoming Traffic in (\S+) per Second'   => 'Ã¿ÃëÁ÷ÈëÁ¿£¨µ¥Î» $1 £©',
     'Outgoing Traffic in (\S+) per Second'   => 'Ã¿ÃëÁ÷³öÁ¿£¨µ¥Î» $1 £©',
     'at which time (.*) had been up for(.*)' => 'Éè±¸ $1 ÒÑÔË×÷Ê±¼ä£º $2 ',
     # '([kMG]?)([bB])/s'                 => '\$1\$2/Ãë',
     # '([kMG]?)([bB])/min'              => '\$1\$2/·Ö',
     '([kMG]?)([bB])/h'                       => '$1$2/Ê±',
     # 'Bits'                                => 'Bits',
...
#        $foo[3]=$quux[0]." kl.".$quux[1]; 
      ...
      return "$wday{$foo[0]}  $foo[3]Äê $month{$foo[2]} $foo[1]ºÅ "; 
    };
...
sub eucjp
{
  ...
  (  
     ...
     'Maximal 5 Minute Incoming Traffic'      => 'ºÇÂç¼õ¿®ÎÌ(5Ê¬´ÖÊ¿¶Ñ)',
     'Maximal 5 Minute Outgoing Traffic'      => 'ºÇÂçÁ÷¿®ÎÌ(5Ê¬´ÖÊ¿¶Ñ)',
     'the device'                             => '¥Ç¥Ğ¥¤¥¹',
     'The statistics were last updated(.*)'   => 'ºÇ½ª¹¹¿·Æü»ş$1',
     ' Average\)</B><BR>'                     => 'Ê¿¶Ñ)</B><BR>',
     ...
     'version'                                => 'version',
     '<B>`Daily\' Graph \((.*) Minute'        => '<B>°ìÆü¥°¥é¥Õ($1Ê¬´Ö',
     ...
     '&nbsp;In:</FONT>'                       => '&nbsp;¼õ¿®:</FONT>',
     '&nbsp;Out:</FONT>'                      => '&nbsp;Á÷¿®:</FONT>',
     '&nbsp;Percentage</FONT>'                => '&nbsp;³ä¹ç:</FONT>',
     'Ported to OpenVMS Alpha by'             => 'OpenVMS AlphaÈÇºîÀ®',
     'Ported to WindowsNT by'                 => 'WindowsNTÈÇºîÀ®',
     'and'                                    => 'and',
     '^GREEN'                                 => 'ÎĞ',
     'BLUE'                                   => 'ÀÄ',
     'DARK GREEN'                             => '°Å¤¤ÎĞ',
...
#     'Oct'   => 'Oct',    'Nov'     => 'Nov',     'Dec'    => 'Dec' 
  ...
  if( $wday{$foo[0]} && $month{$foo[2]} )
	...
	if($foo[3]=~(/(.*)at(.*)/))
      { 
        @quux=split(/ at /,$foo[3]);
        $foo[3]=$quux[1].", ".$quux[0]."Ç¯"; 
      };
      return "$foo[3]$month{$foo[2]}$foo[1]Æü$wday{$foo[0]}"; 
    };
...
sub korean
{
  ...
  (  
    # 'charset=iso-8859-1'                     => 'charset=ks_c_5601-1987',
     ...
     '<B>`Yearly\' Graph \(1 Day'             => '<B>³â°£ ±×·¡ÇÁ (1 ÀÏ ´ÜÀ§', 
     'Incoming Traffic in (\S+) per Second'   => 'ÃÊ´ç ¼ö½ÅµÈ $1',
     'Outgoing Traffic in (\S+) per Second'   => 'ÃÊ´ç ¼Û½ÅµÈ $1',
     'at which time (.*) had been up for(.*)' => '$1 °¡µ¿ ½Ã°£: $2',
     # '([kMG]?)([bB])/s'                 => '\$1\$2/s',
     # '([kMG]?)([bB])/min'              => '\$1\$2/min',
     '([kMG]?)([bB])/h'                       => '$1$2/t',
     # 'Bits'                                => 'Bits',
     ...
     'Ported to OpenVMS Alpha by'             => 'OpenVMS Alpha¿ë °³¹ß', 
     'Ported to WindowsNT by'                 => 'WindowsNT¿ë °³¹ß',
     'and'                                    => '±×¸®°í',
     '^GREEN'                                  => '³ì»ö',
     'BLUE'                                   => 'Ã»»ö',
     'DARK GREEN'                             => 'ÁøÇÑ³ì»ö',
...
%month = 
    (
      ...
      'April'     => '4¿ù',  'May'       => '3¿ù',   'June'      => '6¿ù', 
      'Apr'       => '4¿ù',  'May'       => '3¿ù',   'Jun'       => '6¿ù',
...
sub russian
{
  ...
  (  
     ...
     'version'                                => '×ÅÒÓÉÑ',
     '<B>`Daily\' Graph \((.*) Minute'        => '<B>äÎÅ×ÎÏÊ ÔÒÁÆÉË (ÓÒÅÄÎÅÅ ÚÁ $1 ÍÉÎÕÔ',
...
%wday = 
    (
      ...
      'Wednesday' => ' óÒÅÄÕ',		'Wed' => 'óÒ',
      'Thursday'  => ' şÅÔ×ÅÒÇ',	'Thu' => 'şÔ',
      'Friday'    => ' ğÑÔÎÉÃÕ',	'Fri' => 'ğÔ',
      'Saturday'  => ' óÕÂÂÏÔÕ',	'Sat' => 'óÂ' 
    );
