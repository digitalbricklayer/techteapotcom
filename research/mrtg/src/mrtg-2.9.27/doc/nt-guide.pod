...
nt-guide - The Windows NT Guide to MRTG 2.9.27
...
http://people.ee.ethz.ch/~oetiker/webtools/mrtg/pub Look for mrtg-2.9.27.zip
...
Unzip MRTG to C:\mrtg-2.9.27 on the WindowsNT machine of your choice.
...
and go into F<c:\mrtg-2.9.27\bin>. Type:
...
Get to a cmd prompt and change to the F<c:\mrtg-2.9.27\bin> directory. Type the
following command:
...
results by going into the F<c:\mrtg-2.9.27\bin> directory and typing:
