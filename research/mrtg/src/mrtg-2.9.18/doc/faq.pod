...
Alex van den Bogaerdt E<lt>alex@ergens.op.Het.NetE<gt> maintains the
MRTG FAQ website on
...
F<mrtg-2.9.18/translate> directory and create your own translation file.
...
F<mrtg-2.9.18/contrib> directory. There is a file called F<00INDEX> in
