...
reference - MRTG 2.9.28 configuration reference

=head1 OVERVIEW

The runtime behaviour of MRTG is governed by a configuration file. Run-of-
ther-mill configuration files can be generated with B<cfgmaker>. (Check
...
contributed by S<Rainer Bawidamann E<lt>bawidama@users.sourceforge.netE<gt>>. Please check his
